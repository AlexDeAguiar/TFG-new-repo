...
public class WebcamTextureController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Asegúrate de que haya al menos una webcam disponible
        ...
        // Obtén la primera webcam disponible (puedes ajustar esto según tus necesidades)
    ...
    void OnDestroy()
    {
        // Detén la vista de la webcam cuando el script se destruye
